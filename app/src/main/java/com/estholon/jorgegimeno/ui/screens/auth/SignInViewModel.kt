            ...
            when (val result = withContext(Dispatchers.IO) {
                ...
                is AuthRes.Success -> {
                    ...
                    val analyticModel = AnalyticModel(
                        title = "Sign In",
                        analyticsString = listOf(Pair("Anonymously", "Successful login"))
                    )
                ...
                is AuthRes.Error -> {
                    ...
                    val analyticModel = AnalyticModel(
                        ...
                        analyticsString = listOf(
                            Pair(
                                "Anonymously",
                                "Failed login: ${result.errorMessage}"
                            )
                        )
                    )
                    analytics.sendEvent(analyticModel)
                ...
                is AuthRes.Error -> {
                    ...
                    val analyticModel = AnalyticModel(
                        ...
                        analyticsString = listOf(
                            Pair(
                                "Email",
                                "Failed Sign In: ${result.errorMessage}"
                            )
                        )
                    )
                    analytics.sendEvent(analyticModel)
        ...
        viewModelScope.launch {
            ...
            when (val result = withContext(Dispatchers.IO) {
                ...
                is AuthRes.Success -> {
                    ...
                    val analyticModel = AnalyticModel(
                        title = "Sign In",
                        analyticsString = listOf(Pair("Facebook", "Successful Sign In"))
                    )
                    analytics.sendEvent(analyticModel)
                }
        ...
        viewModelScope.launch {
            ...
            when (val result = withContext(Dispatchers.IO) {
                ...
                is AuthRes.Success -> {
                    ...
                    val analyticModel = AnalyticModel(
                        title = "Sign In",
                        analyticsString = listOf(Pair("$oath", "Successful Sign In"))
                    )
                    analytics.sendEvent(analyticModel)
                }
